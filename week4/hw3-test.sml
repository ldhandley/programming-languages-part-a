...
val test4a3 = longest_string3 ["Pizza","House","Dog"] = "Pizza"
...
(*
val test11 = match (Const(1), 
                    UnitP) 
           = NONE
val test11a = match (Tuple [Const 3, Unit, Constructor ("c0", Const 3), Constructor ("c1", Const 3)], 
